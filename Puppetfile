...
mod 'hieradata',
  :git => 'https://github.com/declarativesystems/hieradata',
  :ref => 'rp'
...
mod 'geoffwilliams-resolv_conf', '0.3.0'
mod 'geoffwilliams-name_service_switch', '0.2.0'
mod 'saz-limits', '2.5.0'
mod 'geoffwilliams-timezone', '0.1.1'
mod 'declarativesystems/puppet_vagrant', '0.5.1'
mod 'saz-sudo', '4.1.0'
...
mod 'geoffwilliams-environment_variable', '0.2.0'
